...
| Titan | 巨人 | 巨 | `a.colossal`1:巨人(防御力が2倍になり、物理耐性x2.0(値が大きいほど大ダメージ)| `a.mutual-physical-amplify`-1:物理増幅(双方物理ダメージ0.8倍) | `c.growth_x1.5` |
...
| 7 | 42 | レポリアンの月宮(Leporian Moon Palace) | 月 | Light Zone(光域):`a.mutual-physical-amplify`-1:物理増幅(双方物理ダメージ0.8倍) | Dark Zone(闇域):`a.mutual-physical-amplify`1:物理増幅(双方物理ダメージ1.2倍) |
