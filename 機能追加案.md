...
| `x.exp_id` | expedition unique |  `x.class`  | `x.drop` (+enemy_type) | name |
|-|-|-|-|-|
| 1 | ELITE1 | Duelist | `i.gauntlet`E, `i.katana`E | |
| 1 | ELITE2 | Fighter | `i.shield`E, `i.robe`E | |
| 1 | ELITE3 | Rogue | `i.sword`E, `i.armor`E | |
| 1 | ELITE4 | Ranger | `i.arrow`E, `i.bolt`E, `i.archery`E | |
| 1 | ELITE5 | Sage | `i.wand`E, `i.grimoire`E, `i.catalyst`E | |
| 1 | BOSS | Fighter | `i.sword`B, `i.grimoire`B| |
| 2 | ELITE1 | Rogue | `i.sword`E, `i.armor`E | |
| 2 | ELITE2 | Fighter | `i.shield`E, `i.robe`E | |
| 2 | ELITE3 | Ranger | `i.arrow`E, `i.bolt`E, `i.archery`E | |
| 2 | ELITE4 | Duelist | `i.gauntlet`E, `i.katana`E |  |
| 2 | ELITE5 | Sage | `i.wand`E, `i.grimoire`E, `i.catalyst`E | |
| 2 | BOSS | Rogue | `i.armor`B , `i.arrow`B | |
| 3 | ELITE1 | Pilgrim | `i.catalyst`E, `i.robe`E | |
| 3 | ELITE2 | Lord | `i.shield`E, `i.sword`E, `i.armor`E | |
| 3 | ELITE3 | Wizard | `i.wand`E, `i.grimoire`E  | |
| 3 | ELITE4 | Ninja | `i.gauntlet`E, `i.katana`E |  |
| 3 | ELITE5 | Rogue | `i.arrow`E, `i.bolt`E, `i.archery`E | |
| 3 | BOSS | Wizard | `i.wand`B, `i.robe`B | |
| 4 | ELITE1 | Rogue | `i.arrow`E, `i.archery`E | |
| 4 | ELITE2 | Samurai | `i.katana`E, `i.shield`E,  `i.gauntlet`E| |
| 4 | ELITE3 | Fighter | `i.armor`E, `i.bolt`E | |
| 4 | ELITE4 | Duelist | `i.robe`E, `i.sword`E |  |
| 4 | ELITE5 | Sage | `i.wand`E, `i.grimoire`E, `i.catalyst`E | |
| 4 | BOSS | Ranger | `i.bolt`B, `i.archery`B | |
| 5 | ELITE1 | Ranger | `i.arrow`E, `i.bolt`E, `i.archery`E | |
| 5 | ELITE2 | Pilgrim | `i.gauntlet`E, `i.catalyst`E | |
| 5 | ELITE3 | Fighter | `i.sword`E, `i.armor`E | |
| 5 | ELITE4 | Lord | `i.shield`E, `i.katana`E, `i.robe`E |  |
| 5 | ELITE5 | Wizard | `i.wand`E, `i.grimoire`E  | |
| 5 | BOSS | Samurai | `i.katana`B , `i.shield`B | |
| 6 | ELITE1 | Fighter | `i.shield`E, `i.robe`E | |
| 6 | ELITE2 | Rogue | `i.sword`E, `i.armor`E | |
| 6 | ELITE3 | Sage | `i.wand`E, `i.grimoire`E, `i.catalyst`E | |
| 6 | ELITE4 | Samurai | `i.katana`E, `i.arrow`E |  |
| 6 | ELITE5 | Ninja | `i.gauntlet`E, `i.bolt`E, `i.archery`E | |
| 6 | BOSS | Sage | `i.armor`B, `i.catalyst`B | |
| 7 | ELITE1 | Lord | `i.sword`E, `i.shield`E | |
| 7 | ELITE2 | Sage | `i.wand`E, `i.grimoire`E, `i.robe`E | |
| 7 | ELITE3 | Pilgrim | `i.armor`E, `i.catalyst`E |  |
| 7 | ELITE4 | Ranger | `i.arrow`E, `i.bolt`E, `i.archery`E  | |
| 7 | ELITE5 | Duelist | `i.gauntlet`E, `i.katana`E | |
| 7 | BOSS | Lord | `i.sword`B, `i.wand`B | |
| 8 | ELITE1 | Fighter | `i.sword`E, `i.armor`E | |
| 8 | ELITE2 | Sage | `i.wand`E, `i.bolt`E | |
| 8 | ELITE3 | Pilgrim | `i.catalyst`E, `i.robe`E, `i.archery`E | |
| 8 | ELITE4 | Samurai | `i.gauntlet`E, `i.katana`E, `i.arrow`E |  |
| 8 | ELITE5 | Wizard | `i.grimoire`E, `i.shield`E  | |
| 8 | BOSS | Ninja | `i.katana`B, `i.bolt`B, `i.grimoire`B | |
