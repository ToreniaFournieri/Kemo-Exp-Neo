...
| 4 | ELITE1 | Rogue | , `i.arrow`EC, `i.archery`EC | |
| 4 | ELITE2 | Samurai | `i.katana`EB, `i.shield`EA,  `i.gauntlet`EB| |
| 4 | ELITE3 | Fighter | `i.armor`EA, `i.bolt`EC | |
| 4 | ELITE4 | Duelist | `i.robe`EA, `i.sword`EA |  |
| 4 | ELITE5 | Sage | `i.wand`EB, `i.grimoire`EB, `i.catalyst`EB | |
| 4 | BOSS | Ranger | `i.bolt`BD, `i.archery`BD | |
| 5 | ELITE1 | Ranger | `i.arrow`EC, `i.bolt`EC, `i.archery`EC | |
| 5 | ELITE2 | Pilgrim | `i.gauntlet`EB, `i.catalyst`EB | |
| 5 | ELITE3 | Fighter | `i.sword`EA, `i.armor`EA | |
| 5 | ELITE4 | Lord | `i.shield`EA, `i.katana`EB, `i.robe`EA |  |
