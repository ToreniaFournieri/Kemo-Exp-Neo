...
|--|--|---|---|
| 0 | (none) | | |
| 1 | `q.squander` | 宴会で 2,000G 浪費する(15%, 450G)　(出撃/神魔戦で中止) | 500 ~ 2,000 G |
| 2 | `q.sleeping` | のべ1時間寝る(75%, 45分)　(出撃/神魔戦で中止) | 20分 ~ 1時間 |
| 3 | `q.exercise` | のべ1時間歩く(25%, 15分)　(出撃/神魔戦で中止) | 45分 ~ 2時間30分 |
| 4 | `q.embezzlement` | 1,000G着服する(60%, 600G)　(出撃/神魔戦で中止) | 250 ~ 1,000G |
| 5 | `q.donation` | 1,500G寄付する(10%, 150G)　(出撃/神魔戦で中止) | 400 ~  2,000G |
| 6 | `q.healing` | のべ2時間治療を受ける (10%, 12分)　(出撃/神魔戦で中止) | 1時間 ~ 2時間 |
| 7 | `q.AFK` | 8時間神から干渉を受けない (10%, 36分)　(出撃/神魔戦で中止) | 4時間 ~ 12時間 |
| 8 | `q.treasure_super_rare` | 超レアを 2個獲得する(0%, 0個)　(出撃/神魔戦で中止) | 1 ~ 2 |
| 9 | `q.treasure_boss_rare` | ボスレアを 30個獲得する(0%, 0個)　(出撃/神魔戦で中止) | 15 ~ 45 |
| 10 | `q.poor_kid` | 100回アイテム獲得空振り(0%, 0個)　(出撃/神魔戦で中止) | 100 ~ 300 |
| 11 | `q.consecutive_wins` | 50連続して踏破する(30%, 15連)　(出撃/神魔戦で中止) | 15 ~ 60 |
| 12 | `q.losers` | 10回敗北する(0%, 0回)　(出撃や神魔戦で中断) | 3 ~ 6 |


- At the end of 帰還中, have chance to pick a side quest bag.
- `t.side_quest_bag` contains
  - ID = 0: 99*(MAX ID) tickets . ID = 1: 1 ticket. ID = 2: 1 ticket. ... 
