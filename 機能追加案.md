...
|--|---|---|
| `q.squander` | 宴会で 2,000G 浪費する(15%, 450G)　(出撃/神魔戦で中止) | 500 ~ 2,000 G |
| `q.sleeping` | のべ1時間寝る(75%, 45分)　(出撃/神魔戦で中止) | 20分 ~ 1時間 |
| `q.exercise` | のべ1時間歩く(25%, 15分)　(出撃/神魔戦で中止) | 45分 ~ 2時間30分 |
| `q.embezzlement` | 1,000G着服する(60%, 600G)　(出撃/神魔戦で中止) | 250 ~ 1,000G |
| `q.donation` | 1,500G寄付する(10%, 150G)　(出撃/神魔戦で中止) | 400 ~  2,000G |
| `q.healing` | のべ2時間治療を受ける (10%, 12分)　(出撃/神魔戦で中止) | 1時間 ~ 2時間 |
| `q.AFK` | 8時間神から干渉を受けない (10%, 36分)　(出撃/神魔戦で中止) | 3時間 ~ 8時間 |
| `q.treasure_super_rare` | 超レアを 2個獲得する(0%, 0個)　(出撃/神魔戦で中止) | 1 ~ 2 |
| `q.treasure_boss_rare` | ボスレアを 30個獲得する(0%, 0個)　(出撃/神魔戦で中止) | 15 ~ 45 |
| `q.poor_kid` | 100回アイテム獲得なしの戦い(0%, 0個)　(出撃/神魔戦で中止) | 100 ~ 300 |
| `q.consecutive_wins` | 50連続して踏破する(30%, 15連)　(出撃/神魔戦で中止) | 15 ~ 60 |
| `q.losers` | 10回敗北する(0%, 0回)　(出撃や神魔戦で中断) | 3 ~ 6 |
