...
- Special Boss replaced by them 

| `x.exp_id` | Replace floor X, room 3 |  `x.type` | `x.class` | `x.drop` | `x.name` |
|-|-|-|-|-|-|
| 1 | 4 | Elite | Lord | `i.shield`BD, `i.robe`BD | |
| 1 | 4 | Elite | Fighter | `i.katana`BD, `i.gauntlet`BD | |
| 2 | 5 | Elite | Wizard | `i.wand`BD, `i.catalyst`BD | |
| 2 | 5 | Elite | Ninja | `i.bolt`BD, `i.archery`BD | |
| 3 | 5 | Elite | Duelist | `i.sword`BD, `i.shield`BD | |
| 3 | 5 | Elite | Pilgrim | `i.catalyst`BD, `i.gauntlet`BD | |
| 4 | 4 | Elite | Rogue | `i.grimoire`BD, `i.arrow`BD | |
| 4 | 4 | Elite | Ninja | `i.robe`BD, `i.sword`BD | |
| 5 | 3 | Elite | Fighter | `i.gauntlet`BD, `i.armor`BD | |
| 5 | 3 | Elite | Sage | `i.wand`BD, `i.catalyst`BD | |
| 6 | 6 | Elite | Samurai | `i.shield`BD, `i.katana`BD | |
| 6 | 6 | Elite | Ranger | `i.arrow`BD, `i.archery`BD | |
| 7 | 2 | Elite | Pilgrim | `i.armor`BD, `i.gauntlet`BD | |
| 7 | 2 | Elite | Wizard | `i.wand`BD, `i.grimoire`BD | |
| 8 | 5 | Elite | Sage | `i.catalyst`BD, `i.robe`BD | |
| 8 | 5 | Elite | Rogue | `i.arrow`BD, `i.sword`BD | |
