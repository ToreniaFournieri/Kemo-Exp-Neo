...
| 4 | 3 | +4 | Normal | D | Fighter | `i.sword`ED, `i.armor`ED, `i.gauntlet`ED | |
| 4 | 3 | +4 | Normal | D | Lord | `i.shield`ED, `i.katana`ED, `i.robe`ED | |
| 4 | 3 | +4 | Normal | D | Sage | `i.wand`ED, `i.catalyst`ED, `i.grimoire`ED | |
| 4 | 3 | +4 | Normal | D | Ranger | `i.arrow`ED, `i.bolt`ED, `i.archery`ED | |
...
- Within the same `x.exp_id`, each drop code resolves to a fixed item.
