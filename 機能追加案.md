...
| Titan | 巨人 | 巨 | `a.colossal`1:巨人(防御力が2倍になり、物理耐性x2.0)| `a.mutual-physical-amplify`-1:物理増幅(双方物理ダメージ0.8倍) | `c.growth_x1.5` |
...
| 5 | `Insect_Swarm` | `Dragon` | `Ursan` | `Ursan` | Samurai | `i.katana`BD , `i.shield`BD |
