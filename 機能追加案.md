...
| `q.treasure_super_rare` | 超レアを 2個獲得する(0%, 0個)　(出撃や神魔戦で中断) | 1 ~ 2 |
| `q.treasure_boss_rare` | ボスレアを 30個獲得する(0%, 0個)　(出撃や神魔戦で中断) | 15 ~ 45 |
| `q.consecutive_wins` | 50連続して踏破する(30%, 15連)　(出撃や神魔戦で中断) | 15 ~ 60 |
