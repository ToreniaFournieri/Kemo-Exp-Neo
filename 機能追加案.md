...
| Ghost | 怨霊 | 怨 | `a.illusion`1. | |  `c.evasion+30`, `c.physical_defense_multiplier_x3/5`, `r.ice_x1.5` |
...
| Mech | 機械 | 機 | `a.counter`2 | | `c.physical_defense_multiplier_x3/5`, `r.thunder_x1.5` |
