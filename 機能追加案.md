...
| `j.arcana` | 魔導の結晶 | 魔 | `c.magical_attack+v` | `d.magical_attack`6 |
| `j.fort` | 堅牢の結晶 | 堅 | `c.physical_defense+v` | `d.physical_defense`6, `d.HP`4 |
| `j.ward` | 障壁の結晶 | 障 | `c.magical_defense+v` | `d.magical_defense`6, `d.HP`4 |
| `j.shade` | 影走の結晶 | 影 | `c.evasion+0.0v` | `d.magical_defense`4 , `d.HP`3  |
