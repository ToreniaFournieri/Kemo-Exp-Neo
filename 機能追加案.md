...
| 6 | ELITE3 | Sage | `i.wand`EB, `i.grimoire`EB, `i.catalyst`EB | |
| 6 | ELITE4 | Samurai | `i.katana`EB, `i.arrow`EC |  |
| 6 | ELITE5 | Ninja | `i.gauntlet`EB, `i.bolt`EC, `i.archery`EC | |
| 6 | BOSS | Sage | `i.armor`BD, `i.catalyst`BD | |
| 7 | ELITE1 | Lord | `i.sword`EA, `i.shield`EA | |
| 7 | ELITE2 | Sage | `i.wand`EB, `i.grimoire`EB, `i.robe`EA | |
| 7 | ELITE3 | Pilgrim | `i.armor`EA, `i.catalyst`EB |  |
| 7 | ELITE4 | Ranger | `i.arrow`EC, `i.bolt`EC, `i.archery`EC  | |
| 7 | ELITE5 | Duelist | `i.gauntlet`EB, `i.katana`EB | |
| 7 | BOSS | Lord | `i.sword`BD, `i.wand`BD | |
| 8 | ELITE1 | Fighter | `i.sword`EA, `i.armor`EA | |
| 8 | ELITE2 | Sage | `i.wand`EB, `i.bolt`EC | |
| 8 | ELITE3 | Pilgrim | `i.catalyst`EB, `i.robe`EA, `i.archery`EC   | |
| 8 | ELITE4 | Samurai | `i.gauntlet`EB, `i.katana`EB, `i.arrow`EC |  |
| 8 | ELITE5 | Wizard | `i.grimoire`EB, `i.shield`EA  | |
