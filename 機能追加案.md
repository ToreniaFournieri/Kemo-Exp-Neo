...
|-|-|-|-|-|
| 1 | ELITE1 | Duelist | `i.gauntlet`EB, `i.katana`EB | |
| 1 | ELITE2 | Fighter | `i.shield`EA, `i.robe`EA | |
| 1 | ELITE3 | Rogue | `i.sword`EA, `i.armor`EA | |
| 1 | ELITE4 | Ranger | `i.arrow`EC, `i.bolt`EC, `i.archery`EC | |
...
| 3 | ELITE1 | Pilgrim | `i.catalyst`EB, `i.robe`EA | |
| 3 | ELITE2 | Lord | `i.shield`EA, `i.sword`EA,| `i.armor`EA |
| 3 | ELITE3 | Wizard | `i.wand`EB, `i.grimoire`EB  | |
| 3 | ELITE4 | Ninja | `i.gauntlet`EB, `i.katana`EB |  |
| 3 | ELITE5 | Rogue | `i.arrow`EC, `i.bolt`EC, `i.archery`EC | |
