...
| Belives in | Theme |
|-|-|
| God of Restoration | heal ar every 4th room, longer sleep 睡眠中, weak against ice |
| God of Attrition | more physical power, hurt at every 4th room|
...
| Name | Title | Class | Represent for | Drop item category, name |
|-|-|-|-|-|
| Seiran | God of Restoration | Pilgrim | Caninian | `i.grimoire`, `i.robe`|
| Garv | God of Attrition | Samurai | Lupinian | `i.katana`, `i.shield` |
| Kyōen | God of Cunning | Rougue | Vulpinian |  `i.bolt`, `i.sword` |
| Dolvar | God of Fortification | Fighter | Ursan | `i.armor`, `i.gauntlet` |
| Miora | Goddess of Fertility | Sage | Felidian | `i.robe`, `i.catalyst` |
| Rondel | God of Resonance | Wizard | Mustelid | `i.wand`, `i.grimoire` |
| Lira | Goddess of Precision | Ranger | Leporian | `i.arrow`, `i.archery` |
| Forne | God of Fate | Lord | Cervin | `i.sword`, `i.robe` |
| Skuva | God of Dusk | Ninja | Murid | `i.bolt`,`i.katana` |
| Tanue | Goddess of Mirage | Duelist | Procyonian | `i.sword`, `i.gauntlet` |
| Noctyra | God of Oblivion | Samurai | - | `i.bolt`, `i.katana` |
| Eris | Goddess of discord | Pilgrim | - | `i.grimoire`, `i.robe` |

- **Gods Battle (神魔戦)**
  - Loot Gate Condition: Collect 20 Mythic items in dungeons to unlock Gods Battle.
  - UI / Trigger:
  ...
  - Battle Rules:
    ...
    - This battle is a special encounter, separate from standard boss fights.
  - Outcome Handling:
    - **On Victory**
    ...
    - **On Defeat**
      ...
      - The player may retry the Gods Battle without re-collecting Mythic items.
...
| Kyōen | `i.sword` | 欺きの短剣 |
| Dolvar | `i.armor` | 不壊の鎧 |
| Dolvar | `i.gauntlet` | 鉄壁の篭手 |
| Miora | `i.robe` | 豊穣の衣 |
| Miora | `i.catalyst` | 命芽の触媒 |
| Rondel | `i.wand` | 共鳴の杖 |
| Rondel | `i.grimoire` | 響界の魔導書 |
| Lira | `i.arrow` | 必中の矢 |
| Lira | `i.archery` | 狙撃の弓 |
| Forne | `i.sword` | 宿命の剣 |
| Forne | `i.robe` | 予見の外套 |
...
| Skuva | `i.katana` | 影没の刃 |
| Tanue | `i.sword` | 幻刃の細剣 |
| Tanue | `i.gauntlet` | 虚像の手甲 |
| Noctyra | `i.bolt` | 忘却の矢 |
| Noctyra | `i.katana` | 虚無ノ太刀 |
| Eris | `i.grimoire` | 混沌の聖典 |
| Eris | `i.robe` | 破調の法衣 |
...
| mythic rare | (base_power is pre defined) + **all** subtle_power`d.`, `e.`, or `c.` bonus, one `b.` bonus**, but no base c.multiplier |
