...
| Rarelity | `rarelity.amplifier` | `rarelity.tier_upgrade` |
|------|--------|--------|
| common | x1.0 | 0 |
| uncommon | x1.2 | 0 |
| elite rare | x1.6 | 0 |
...
| mythic rare | base_power(+ `rarelity.tier_upgrade`) x `type_amplifier` x rarelity.amplifier + **all** subtle_power`d.`, `e.`, or `c.` bonus, one `b.` bonus**, but no base c.multiplier |
