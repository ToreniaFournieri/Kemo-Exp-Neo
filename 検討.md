...
| Name | Title | Class | Represent for | Drop item tier | Drop item category |
|-|-|-|-|-|-|
| Seiran | God of Restoration | Pilgrim | Caninian | 3 | `i.grimoire`, `i.robe`|
| Garv | God of Attrition | Samurai | Lupinian | 4 | `i.katana`, `i.shield` |
| Kyōen | God of Cunning | Rougue | Vulpinian | 5 |  `i.bolt`, `i.sword` |
| Dolvar | God of Fortification | Fighter | Ursan | 6 | `i.armor`, `i.gauntlet` |
| Miora | Goddess of Fertility | Sage | Felidian | 7 | `i.robe`, `i.catalyst` |
| Rondel | God of Resonance | Wizard | Mustelid | 8 | `i.wand`, `i.grimoire` |
| Lira | Goddess of Precision | Ranger | Leporian | 8 | `i.arrow`, `i.archery` |
| Forne | God of Fate | Lord | Cervin | 8 | `i.sword`, `i.robe` |
| Skuva | God of Dusk | Ninja | Murid | 9 | `i.bolt`,`i.katana` |
| Tanue | Goddess of Mirage | Duelist | Procyonian | 9 | `i.sword`, `i.gauntlet` |
| Noctyra | God of Oblivion | Samurai | - | 10 | `i.bolt`, `i.katana` |
| Eris | Goddess of discord | Pilgrim | - | 10 | `i.grimoire`, `i.robe` |
