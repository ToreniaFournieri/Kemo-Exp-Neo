...
- 命中期待値
  - カッコ内の数値は攻撃側命中 - 相手側回避 の差

| 減衰率 | 5 hits | 10 hits | 15 hits | 20 hits | 30 hits | 40 hits |
| ----: | -----: | ------: | ------: | ------: | ------: | ------: |
| ×0.98 (+80) |   4.80 |    9.15 |   13.20 |   16.62 |   22.67 |   27.55 |
| ×0.96 (+60) |   4.62 |    8.77 |   12.07 |   14.27 |   17.49 |   20.42 |
| ×0.94 (+40) |   4.45 |    8.34 |   11.10 |   12.21 |   14.84 |   16.82 |
| ×0.92 (+20) |   4.29 |    7.91 |    9.89 |   10.54 |   12.63 |   13.81 |
| ×0.90 (0) |   4.10 |    6.51 |    7.71 |    8.78 |    9.58 |    9.85 |
| ×0.88 (-20)|   3.95 |    6.02 |    6.88 |    7.52 |    7.96 |    8.19 |
| ×0.86 (-40)|   3.80 |    5.57 |    6.13 |    6.60 |    7.03 |    7.18 |
...
- (Simplified) Party base HP: 100 + (Total sum of individual (( L_eff x `b.vitality` ) x (`b.vitality` + `b.mind`) / 20) )
- Paty member is 6, and their `b.vitality` and `b.mind` are 10. 

| Level | Party HP | Dungeons|
|-------|----------|------|
| 8 | 580 | 1.原 |
| 16 | 1,207 | 2.崖 |
| 24 | 2,215 | 3.樹 |
...
| 21 | 10,012 | 48,282 |
| 31 | 100,178 | 486,580 |
| 41 | 1,002,373 | 4,872,152 |
| 51 | 10,029,667 | 48,753,865 |

| Level | XP to next | Total XP to next |
|---:|---:|---:|
| 61 | 100,356,107 | 487,831,040 |
| 71 | 1,004,155,815 | 4,881,204,909 |
| 81 | 10,047,509,110 | 48,840,980,191 |
| 91 | 100,534,635,970 | 488,699,253,227 |
| 99 | 634,631,391,893 | 3,084,945,645,920 |



- `x.exp_experience_mult` table

| `x.tier` | `x.enemy_level` | `x.exp_experience_mult` |
|----|---|----|
| 1 | 1 | x1 |
| 2 | 8 | x25 |
| 3 | 16 | x125 |
...
- Addition to `x.enemy_level` table

| `x.floor` | addition to `x.recommend_level` |
|----|----|
| 1 | +0 |
| 2 | +1 |
| 3 | +2 |
...
- `x.experience_penalty` table

| Diff level | penalty multiplier |
|---|----|
| ~0 | 1 |
| 1 | /2 |
| 2 | /4 |
...
| Name | Title | Class | Represent for | Theme |
|-|-|-|-|-|
| Seiran | God of Restoration | Pilgrim | Caninian | heal ar every 4th room, longer sleep 睡眠中, weak against ice |
| Garv | God of Attrition | Samurai | Lupinian | more physical power, hurt at every 4th room|
| Kyōen | God of Cunning | Duelist | Vulpinian | +magical defense, sustain intimacy, abscond (lower saving money) |
| Dolvar | God of Fortification | Fighter | Ursan | +physical defense, longer healing 休息中, weak against thunder |
| Miora | Goddess of Fertility | Sage | Felidian  | move +1 faster, longer fest 宴会中, weak against fire |
| Rondel | God of Resonance | Wizard | Mustelid | resonance, resonance works ranged attack too, -HP |
| Lira | Goddess of Precision | Ranger | Leporian | +accuracy, -evasion, longer 探索中 |
| Forne | God of Fate | Lord | Cervin | alter future, longer praying 祈り中 |
| Skuva | God of Dusk | Ninja | Murid | +evasion, -magical defense, longer trading 売却中 |
| Tanue | Goddess of Mirage | Rougue | Procyonian | +more magical power, -lower physical defense  |
| Noctyra | God of Oblivion | - | - | hurt |
| Eris | Goddess of discord | Pilgrim | - | 1 member got ⚠️antagonism, one more reward chance |

- 神魔戦 (Gods battle)
  - Loot gataecondition: If you collect 100 of mythic rare items in the dungeon, unlock JInma battle
  - The "出撃" button turnes into "神魔戦" button, and Player press it, then special battle happens. (no Gods battle while auto-run 自動周回 mode. need to press button explicitly)
    - The Boss is replaced by god, a very formitive enemy.
    - If player defeats the god, "神魔戦" button back to "出撃" button, and Loot gate condition reset to 0 collected mythic rare items. (repeat this)
    - If player failed to beat the god, "神魔戦" button remains, so they can try it again.
