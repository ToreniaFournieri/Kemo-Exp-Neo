...
| Kyōen | God of Cunning | Rougue | Vulpinian | `a.momentum`2 | 5 |  `i.archery`, `i.sword` |
...
| Rondel | God of Resonance | Wizard | Mustelid | `a.resonance`4 | 7 | `i.wand`, `i.bolt` |
...
| Skuva | God of Dusk | Ninja | Murid | `a.stealth`1 | 8 | `i.arrow`,`i.catalyst` |
