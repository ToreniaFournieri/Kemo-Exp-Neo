...
| Kyōen | God of Cunning | Rougue | Vulpinian | `a.momentum`2 | 5 |  `i.bolt`, `i.sword` |
| Dolvar | God of Fortification | Fighter | Ursan | `a.cyborgization`2 | 6 | `i.armor`, `i.gauntlet` |
| Miora | Goddess of Fertility | Sage | Felidian | `a.firststrike`2 | 7 | `i.robe`, `i.catalyst` |
| Rondel | God of Resonance | Wizard | Mustelid | `a.resonance`4 | 8 | `i.wand`, `i.grimoire` |
| Lira | Goddess of Precision | Ranger | Leporian | `a.composure`2 | 8 | `i.arrow`, `i.archery` |
| Forne | God of Fate | Lord | Cervin | `a.focus`2 | 8 | `i.sword`, `i.robe` |
| Skuva | God of Dusk | Ninja | Murid | `a.stealth`1 | 9 | `i.bolt`,`i.katana` |
| Tanue | Goddess of Mirage | Duelist | Procyonian | 9 | `a.illusion`1 | 9 | `i.sword`, `i.gauntlet` |
| Noctyra | God of Oblivion | Samurai | - | `a.rage`2, `a.firststrike`2 | 10 | `i.bolt`, `i.katana` |
| Eris | Goddess of discord | Pilgrim | - | `a.momentum`2, `a.resonance`4, `a.stealth`1 | 10 | `i.grimoire`, `i.robe` |
