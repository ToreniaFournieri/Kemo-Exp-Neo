...
| Kyōen | God of Cunning | Duelist | Vulpinian | `i.sword`, `i.gauntlet`` |
| Dolvar | God of Fortification | Fighter | Ursan | `i.armor`, `i.bolt` |
...
| Skuva | God of Dusk | Ninja | Murid | `i.shield`,`i.katana` |
| Tanue | Goddess of Mirage | Rougue | Procyonian | `i.bolt`, `i.archery` |
| Noctyra | God of Oblivion | Samurai | - | `i.armor`, `i.katana` |
